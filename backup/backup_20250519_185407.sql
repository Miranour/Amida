...
CREATE TABLE public."Institutions" (
    ...
    "maxAppointmentsPerDay" integer DEFAULT 20,
    "breakTime" json DEFAULT '{"start":"12:00","end":"13:00"}'::json,
    holidays json DEFAULT '[]'::json,
    "notificationSettings" json DEFAULT '{"email":true,"sms":false,"push":true}'::json,
    "emailNotifications" json DEFAULT '{"newAppointment":true,"appointmentReminder":true,"appointmentCancellation":true,"appointmentConfirmation":true}'::json,
    "smsNotifications" json DEFAULT '{"newAppointment":false,"appointmentReminder":false,"appointmentCancellation":false,"appointmentConfirmation":false}'::json
);
...
COPY public."Institutions" (id, "userId", "institutionName", "taxNumber", "institutionPhone", "institutionEmail", "institutionAddress", city, district, "institutionType", "workingHours", "isVerified", "isActive", created_at, updated_at, logo, description, website, "socialMedia", "appointmentDuration", "maxAppointmentsPerDay", "breakTime", holidays, "notificationSettings", "emailNotifications", "smsNotifications") FROM stdin;
1	3	Arslanlar Diş Kliniği	7218239	05308819621	vavelyak@gmail.com	çaydaçıra mahallesi	Elazığ	Elazığ	Diş Kliniği	{}	f	t	2025-05-11 18:29:23.935+03	2025-05-11 18:29:23.935+03	\N	\N	\N	{}	30	20	{"start":"12:00","end":"13:00"}	[]	{"email":true,"sms":false,"push":true}	{"newAppointment":true,"appointmentReminder":true,"appointmentCancellation":true,"appointmentConfirmation":true}	{"newAppointment":false,"appointmentReminder":false,"appointmentCancellation":false,"appointmentConfirmation":false}
3	10	diş kliniği	123456	54655447	kurum@gmail.com	djksjdlajd	ağrı	merkez	Berber	{}	f	t	2025-05-13 14:23:42.859+03	2025-05-13 14:23:42.859+03	\N	\N	\N	{}	30	20	{"start":"12:00","end":"13:00"}	[]	{"email":true,"sms":false,"push":true}	{"newAppointment":true,"appointmentReminder":true,"appointmentCancellation":true,"appointmentConfirmation":true}	{"newAppointment":false,"appointmentReminder":false,"appointmentCancellation":false,"appointmentConfirmation":false}
2	9	Ay Berber	7654321	5461232123	ayberber@gmail.com	fırat mah 	Mardin	Mardin	Berber	{}	f	t	2025-05-12 13:50:41.274+03	2025-05-14 02:01:38.196+03	/uploads/logos/logo-1747155872662-449532459.jpg		\N	{"instagram":"","facebook":"","twitter":"","linkedin":""}	30	20	{"start":"12:00","end":"13:00"}	[]	{"email":true,"sms":false,"push":true}	{"newAppointment":true,"appointmentReminder":true,"appointmentCancellation":true,"appointmentConfirmation":true}	{"newAppointment":false,"appointmentReminder":false,"appointmentCancellation":false,"appointmentConfirmation":false}
4	11	diş kliniği	3454	45466535	gdfg@gmail.com	djksjdlajd	ağrı	merkez	Diş Kliniği	{}	f	t	2025-05-14 02:59:37.851+03	2025-05-14 02:59:37.851+03	\N	\N	\N	{}	30	20	{"start":"12:00","end":"13:00"}	[]	{"email":true,"sms":false,"push":true}	{"newAppointment":true,"appointmentReminder":true,"appointmentCancellation":true,"appointmentConfirmation":true}	{"newAppointment":false,"appointmentReminder":false,"appointmentCancellation":false,"appointmentConfirmation":false}
\.
...
20240320_add_institution_settings.js
\.
...
9	miran	oğur	230541127@firat.edu.tr	76578588768	$2a$10$9e2euEh/cmmxOmv1XIM/veUxpm8TcGV.Aif9.Ch/nKOdCimcEytx2	2025-05-11		Mardin	Mardin	institution	t	2025-05-12 13:50:41.246+03	2025-05-12 13:50:41.246+03
10	mehmet	a	jsksjskjjd@gmail.com	89477579459	$2a$10$tqyCCrJEyw/hfpqH9wFUheCAGFrsjOk/bT0/IS6mRtCWY6Nj.An1a	2025-05-13		ağrı	merkez	institution	t	2025-05-13 14:23:42.829+03	2025-05-13 14:23:42.829+03
11	mehmet	a	asdsf@gmail.com	12334	$2a$10$QR42FyDfF8Q2She4xjzi0OkZv66w0sj0RQ5nxtN.bL7b/nf4rX5BC	2025-05-13		ağrı	merkez	institution	t	2025-05-14 02:59:37.824+03	2025-05-14 02:59:37.824+03
\.
